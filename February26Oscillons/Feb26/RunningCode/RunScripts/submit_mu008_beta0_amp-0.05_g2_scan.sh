#!/bin/bash -l
#
# A = -0.05 g2 scan at lambda_GB = 0, completing the existing A=-0.05 grid.
# Fixed: mu=0.08, R=3, beta=0 (coupling=quadratic_0), a=b=0, dr=1/24, T=800.
#
# The (lambda_GB=0, g2=0) cell already exists at A=-0.05 (older tag, pre
# g2-in-tag naming convention), so only the g2!=0 cells are submitted here:
#   g2 in {2, 4, 8, 10, 12}
#
...
#SBATCH --job-name=l${LGB}_g${G2}_A005
